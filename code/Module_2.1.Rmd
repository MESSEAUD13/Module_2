...
here::here("data", "Workshop_1", "reef_cover_log.csv")
)
```

```{r}
acoustic_stream <- read_tsv(
here::here("data", "Workshop_1", "acoustic_telemetry_stream.txt")
)
```
```{r}
# Practice Import C: Targeting a specific sheet in a multi-tab Excel spreadsheet
fisheries_annual <- read_excel(
here::here("data", "Workshop_1", "fish_catch_data.xlsx"),
...
file = here::here("data", "Workshop_1", "mangrove_survey_raw.csv"),
skip = 5,
...
mangrove_data <- read_csv(
here::here("data", "Workshop_1", "mangrove_survey_raw.csv"),
skip = 5,
na = c(".", "NA", "9999", "ND", "blank")
)
```
