...
---
title: "Keystone_exercice"
format: html
editor: visual
---

---
title: "R4MS Workshop 2 - Key Stone Final Exercice"
...
```{r}
catch1 <- read_excel("data/Workshop_2/estuary_catch_log.xlsx", sheet = 1)
...
```{r}
sensor_raw <- read.csv("data/Workshop_2/estuary_sonde_data.csv")
```
...
2.  Implicit zero observations 4 x spp 4 x sites 30 surveys
